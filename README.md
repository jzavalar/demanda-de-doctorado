# ride_demanda-de-doctorado.md
Repositorio para el artículo en RIDE sobre estudio de la demanda de un Doctorado en Ciencias en Paisaje y Turismo Rural en el Colegio de Postgraduados, Campus Córdoba. Contiene datos levantados entre abril y mayo de 2024 (N=113, 100 interesados), procedimientos y scripts de análisis. Garantiza total transparencia y reproducibilidad del análisis.

# Datos y Scripts de Procesamiento: Artículo: Demanda Potencial para un Doctorado en Ciencias
### Paisaje y turismo rural · desarrollo, manejo y aprovechamiento del paisaje rural
...
> cumplimiento a la transparencia de datos, métodos y materiales solicitada por la revista
> de destino, y para que cualquier persona pueda **reproducir de principio a fin** el proceso
> de preparación de los datos, previo a su análisis y su posterior análisis.
