...
| 15 | [`datos_15.figuras/`](datos_15.figuras) | Las 15 figuras (`.png`) del análisis y los mapas, más `pies-de-figura.md` (texto listo para pegar en el artículo, formato RIDE) y `datos_15b.tablas-mapas.xlsx` | PNG / Markdown / Excel |
