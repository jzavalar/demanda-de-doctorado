...
| 17 | [`datos_17.referencias-bibliograficas.md`](datos_17.referencias-bibliograficas.md) | Referencias en formato APA 7 de fuentes externas usadas en el repositorio (por ahora, el geojson del mapa), listas para copiar a la sección de Referencias del artículo | Markdown |
